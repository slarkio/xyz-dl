...
from .utils.mock_http import create_network_error, create_timeout_error, create_http_error
...
class TestNetworkExceptions:
    ...
    async def test_connection_error(self, http_mocker, sample_urls):
        ...
        assert "Connection refused" in str(exc_info.value) or "Network error" in str(exc_info.value)
    ...
    async def test_http_500_error(self, http_mocker, sample_urls):
        ...
        # 模拟500错误
        http_mocker.set_failure(test_url, create_http_error(500, "Internal Server Error"))
...
class TestParsingExceptions:
    ...
    async def test_empty_html_content(self):
        ...
        with pytest.raises(ParseError) as exc_info:
            await parser.parse_episode_info("", "https://www.xiaoyuzhoufm.com/episode/test")
    ...
    async def test_malformed_html_content(self):
        ...
        malformed_html = "<html><head><title>Test</title></head><body><p>Incomplete HTML"
        
        with pytest.raises(ParseError) as exc_info:
            await parser.parse_episode_info(malformed_html, "https://www.xiaoyuzhoufm.com/episode/test")
    ...
    async def test_missing_json_script(self):
        ...
        with pytest.raises(ParseError) as exc_info:
            await parser.parse_episode_info(html_without_json, "https://www.xiaoyuzhoufm.com/episode/test")
    ...
    async def test_invalid_json_ld_content(self):
        ...
        with pytest.raises(ParseError) as exc_info:
            await parser.parse_episode_info(html_with_invalid_json, "https://www.xiaoyuzhoufm.com/episode/test")
    ...
    async def test_incomplete_json_ld_data(self):
        ...
        # 应该能解析，但会使用默认值
        episode_info = await parser.parse_episode_info(html_with_incomplete_json, "https://www.xiaoyuzhoufm.com/episode/test")
...
class TestShowNotesExtractionExceptions:
    ...
    async def test_missing_show_notes_section(self, test_data_manager, sample_urls):
        ...
        episode_info = await parser.parse_episode_info(html_without_show_notes, "https://www.xiaoyuzhoufm.com/episode/test")
    ...
    async def test_empty_show_notes_content(self):
        ...
        episode_info = await parser.parse_episode_info(html_with_empty_show_notes, "https://www.xiaoyuzhoufm.com/episode/test")
...
class TestCompositeParserFallback:
    ...
    async def test_fallback_to_html_parser(self):
        ...
        episode_info = await parser.parse_episode_info(basic_html, "https://www.xiaoyuzhoufm.com/episode/test")
    ...
    async def test_all_parsers_fail(self):
        ...
        with pytest.raises(ParseError) as exc_info:
            await parser.parse_episode_info(invalid_html, "https://www.xiaoyuzhoufm.com/episode/test")
...
class TestEdgeCases:
    ...
    async def test_unicode_content_handling(self):
        ...
        episode_info = await parser.parse_episode_info(unicode_html, "https://www.xiaoyuzhoufm.com/episode/test")
